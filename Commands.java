...
public class Commands {
	...
	public static void main(String Args[]) {
		...
		map[1][7][4] = new Room(false,true, false, true, 0,"Riverbank", "You are at the north shore of a river, far too deep and wide for crossing. on the side of the shore there is board on which is written Dholakpur 0km ; Pehalwanpur 4 kms.\n",new vehicle("machine",true));
	...
	public static void display(){
		if(running) {	
			...
			if (Commands.currentRoom ==Commands.map[1][7][4] &&Inventory.searchInventory("gold")){
				play.textArea.append("The machine started working as you have gold. But you can see someone standing near it.\nHe is Prof. Dhoomketu and upon meeting you he tells you that he is not Prof. Dhoomketu, he is Dr. Sheldon Cooper who was unable to come back due to unavailability of fuel and has been sending signals for help.\n Now the quest is complete,he congratulates you and invites you to enter the machine.\n");
				row = 0;
				col =3;
				level =0;
			}
		...
		if(currentRoom.isVehiclePresent(object)){
			if(currentRoom.playerEnter(object)){
				...
				if (currentRoom == map[1][7][4]&&object.equals("machine")){
					out = ("\n\nAuditorium \nThe bell rings and you wake up from power nap. Students are talking all about Dr. Sheldon Cooper inventing Time Machine.Was it a dream or a fantastic time travel experience?\n\n BAZZINGA!!");
					play.textArea.append(out+"\n");
					level= 0;
